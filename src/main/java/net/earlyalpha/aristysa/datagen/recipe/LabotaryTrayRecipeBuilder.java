...
public class LabotaryTrayRecipeBuilder implements RecipeBuilder {
    private final Item result;
    private final Ingredient[] ingredients;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.advancement();

    public LabotaryTrayRecipeBuilder(ItemLike[] ingredients, ItemLike result, int count) {
    ...
    public static class JsonBuilder implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(Aristysa.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_labotary_tray");
        }
