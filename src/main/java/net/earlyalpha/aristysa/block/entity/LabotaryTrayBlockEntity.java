...
import net.earlyalpha.aristysa.screen.LabotaryTrayMenu;
...
public class LabotaryTrayBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public LabotaryTrayBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntities.LABOTARY_TRAY_BE.get(), pPos, pBlockState);
        this.data = new ContainerData() {
            ...
            public void set(int i, int v) {
                switch (i) {
                    case 0: LabotaryTrayBlockEntity.this.progress = v;
                    case 1: LabotaryTrayBlockEntity.this.maxProgress = v;
                }
            }
    ...
    public Component getDisplayName() {
        return Component.translatable("Labotary Tray");
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int i, Inventory inventory, Player player) {
        return new LabotaryTrayMenu(i,inventory,this,this.data);
    }

    @Override
    protected void saveAdditional(CompoundTag nbt) {
        nbt.put("inventory",itemStackHandler.serializeNBT());
        nbt.putInt("labotary_tray.progress",progress);
    ...
    public void load(CompoundTag nbt) {
        ...
        progress = nbt.getInt("labotary_tray.progress");
    }
    ...
    private Optional<LabotaryTrayRecipe> getCurrentRecipe() {
        ...
        return this.level.getRecipeManager().getRecipeFor(LabotaryTrayRecipe.Type.INSTANCE,inventory,level);
    }
